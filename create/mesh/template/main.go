...
import (
	"${VarName}/app"
	"github.com/dawnsgo/dawn/locate/${VarLocator}"
	"github.com/dawnsgo/dawn/registry/${VarRegistry}"
	"github.com/dawnsgo/dawn/transport/${VarTransporter}"
	"github.com/dawnsgo/dawn"
	"github.com/dawnsgo/dawn/cluster/mesh"
)
